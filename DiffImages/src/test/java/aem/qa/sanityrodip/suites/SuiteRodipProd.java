...
import aem.qa.sanityrodip.tests.TestRodipProd;
...
public class SuiteRodipProd {
	...
	public static void startSelenium() throws Exception {
		...
		TestTemplate.driver.get("https://rodip.roche.com/RDP_Registration?country=CH&lang=de_CH");
