...
public class TestRodipPreprod extends TestTemplate {
	...
	public static List<Parameters[]> primeNumbers() {
		List<Parameters> urlList = CommonUtils.readLinksFromFileIntoObject("src/test/resources/" + TestRodipPreprod.class.getSimpleName() + ".txt");
	...
	public TestRodipPreprod(Parameters param)
	{
		this.param = param;
	}
