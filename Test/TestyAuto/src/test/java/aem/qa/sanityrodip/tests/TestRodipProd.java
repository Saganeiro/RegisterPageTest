...
public class TestRodipProd extends TestTemplate {
	...
	public static List<Parameters[]> primeNumbers() {
		List<Parameters> urlList = CommonUtils.readLinksFromFileIntoObject("src/test/resources/" + TestRodipProd.class.getSimpleName() + ".txt");
	...
	public TestRodipProd(Parameters param)
	{
		this.param = param;
	}
